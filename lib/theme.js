 ...
 * lib/theme.js
 *
 * Single source of truth for Ubuntu Africa's ecosystem branding.
...
export const THEMES = {
  learn: {
    slug: "learn",
    name: "Ubuntu Learn",
    tagline: "Develop the mind — knowledge and wisdom.",
    emoji: "🎓",
    primary: "#24476b",
    primaryDeep: "#16304d",
    status: "waitlist",
  ...
  connect: {
    slug: "connect",
    name: "Ubuntu Connect",
    tagline: "Develop the heart — relationships and family.",
    emoji: "💛",
    primary: "#1b4332",
    primaryDeep: "#122b20",
    status: "live",
  ...
  jobs: {
    slug: "jobs",
    name: "Ubuntu Jobs",
    tagline: "Develop the professional — career and purpose.",
    emoji: "💼",
    primary: "#92400e",
    primaryDeep: "#6b2f0a",
    status: "waitlist",
  ...
  business: {
    slug: "business",
    name: "Ubuntu Business",
    tagline: "Develop the builder — entrepreneurship and enterprise.",
    emoji: "🌱",
    primary: "#6b2545",
    primaryDeep: "#4a1830",
    status: "waitlist",
  ...
  health: {
    slug: "health",
    name: "Ubuntu Health",
    tagline: "Develop the body — health and wellbeing.",
    emoji: "🩺",
    primary: "#0e7c7b",
    primaryDeep: "#095452",
    status: "waitlist",
  ...
  money: {
    slug: "money",
    name: "Ubuntu Money",
    tagline: "Develop the steward — financial wisdom and security.",
    emoji: "💰",
    primary: "#8a6d1f",
    primaryDeep: "#5c4914",
    status: "waitlist",
  ...
  farmer: {
    slug: "farmer",
    name: "Ubuntu Farmer",
    tagline: "Develop the provider — food production and agricultural prosperity.",
    emoji: "🌾",
    primary: "#5b6b2f",
    primaryDeep: "#3d481f",
    status: "waitlist",
  ...
  leadership: {
    ...
    tagline: "Develop the leader — influence, vision, and community impact.",
    emoji: "🦅",
    primary: "#1e3a5f",
    primaryDeep: "#122540",
    status: "waitlist",
  ...
  care: {
    slug: "care",
    name: "Ubuntu Care",
    tagline: "Develop the caregiver — family, elders, and those who serve others.",
    emoji: "🤝",
    primary: "#7b3f6e",
    primaryDeep: "#522a49",
    status: "waitlist",
  ...
  justice: {
    slug: "justice",
    name: "Ubuntu Justice",
    tagline: "Develop the advocate — rights, fairness, and access to justice.",
    emoji: "⚖️",
    primary: "#5c3d11",
    primaryDeep: "#3d280b",
    status: "waitlist",
...
// Ubuntu Africa Ecosystem Universal Transformation Engine spec.
...
export function getEcosystemList(excludeSlug) {
  return Object.values(THEMES).filter((t) => t.slug !== excludeSlug);
}
